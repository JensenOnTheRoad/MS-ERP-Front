        ...
        >
          ...
          <el-table-column prop="type" label="类型">
            <template #default="scope">
              <div v-if="scope.row.type == 0">物资仓库</div>
              <div v-else>商品仓库</div>
            </template>
          </el-table-column>
          <!-- 操作 -->
...
// 编辑物资界面
import WarehouseEdit from './warehouse_edit.vue';
...
const url = global_url + '/warehouse/warehouse/getAllPaging';
const url_search = global_url + '/warehouse/warehouse/fuzzySearch';
const url_delete = global_url + '/warehouse/warehouse/delete';
