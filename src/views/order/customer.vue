...
// 编辑物资界面
import ComstomerEdit from './customer_edit.vue';
...
const url = global_url + '/order/customers/getAllPaging';
const url_search = global_url + '/order/customers/fuzzySearch';
const url_delete = global_url + '/order/customers/delete';
