...
const url = global_url + '/commodity/commodity/getAllPaging';
const url_search = global_url + '/commodity/commodity/fuzzySearch';
const url_delete = global_url + '/commodity/commodity/delete';
