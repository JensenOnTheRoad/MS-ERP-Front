...
// 编辑物资界面
import MaterialEdit from './material_edit.vue';
...
const url = global_url + '/production/material/getAllPaging';
const url_search = global_url + '/production/material/fuzzySearch';
const url_delete = global_url + '/production/material/delete';
