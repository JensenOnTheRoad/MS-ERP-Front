<template>
  ...
  >
    ...
    <el-form-item label="物品规格" prop="specification">
      <el-input v-model="form.data.specification" style="max-width: 200px" placeholder="请输入规格"/>
    </el-form-item>
...
const url = global_url + '/production/material/insertOrUpdate';
const url_getOne = global_url + '/production/material/getOne';
