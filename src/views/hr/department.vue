...
// 编辑物资界面
import Department from './department_edit.vue';
...
const url = global_url + '/hr/department/getAllPaging';
const url_search = global_url + '/hr/department/fuzzySearch';
const url_delete = global_url + '/hr/department/delete';
