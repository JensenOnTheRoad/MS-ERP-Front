...
// 编辑物资界面
import TypeIo from './type_io_edit.vue';
...
const url = global_url + '/financial/type-io/getAllPaging';
const url_search = global_url + '/financial/type-io/fuzzySearch';
const url_delete = global_url + '/financial/type-io/delete';
